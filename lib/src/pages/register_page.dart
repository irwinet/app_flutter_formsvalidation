...
import 'package:app_flutter_formsvalidation/src/providers/user_providers.dart';
...
class RegisterPage extends StatelessWidget {
  ...
  Widget _createBackground(BuildContext context){
    ...
    final backgroundMorado = Container(
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Text('Monitoreo Actitudinal',style: TextStyle(color: Colors.white, fontSize: 25.0),),
            ],
          ),
        ),
      ],
